...
public class AchatRest {
	...
	public int save(@RequestBody Achat achat) {
		return achatService.save(achat, achat.getProduitAchats(),achat.getAchatBudgetEntites());
	}

	@PutMapping("/")
	public int updateAchat(@RequestBody Achat achat) {
		return achatService.updateAchat(achat, achat.getProduitAchats(),achat.getAchatBudgetEntites());
	}
